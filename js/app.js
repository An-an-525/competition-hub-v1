...
/* --- Page Meta for SEO --- */
var PAGE_META = {
  home: { title: '长沙理工大学学科竞赛信息平台', desc: '覆盖55+项学科竞赛，AI智能问答，一站式竞赛查询与报名管理' },
  ai: { title: 'AI智能问答 - 长沙理工大学学科竞赛信息平台', desc: 'AI智能问答，快速查询竞赛信息、专业介绍、校园生活' },
  academic: { title: '学业助手 - 长沙理工大学学科竞赛信息平台', desc: '专业查询、选课指南、考试安排、成绩查询' },
  campus: { title: '校园生活 - 长沙理工大学学科竞赛信息平台', desc: '校区导览、食堂、图书馆、宿舍、交通指南' },
  admission: { title: '招生咨询 - 长沙理工大学学科竞赛信息平台', desc: '招生政策、专业大全、录取分数线、学费标准' },
  news: { title: '校园资讯 - 长沙理工大学学科竞赛信息平台', desc: '通知公告、社团活动、二手交易、失物招领' },
  competition: { title: '学科竞赛 - 长沙理工大学学科竞赛信息平台', desc: '55+项学科竞赛大全，在线报名，截止提醒' },
  toolbox: { title: '工具箱 - 长沙理工大学学科竞赛信息平台', desc: 'GPA计算器、学分统计、倒计时、课程表、番茄钟' },
  profile: { title: '个人中心 - 长沙理工大学学科竞赛信息平台', desc: '管理你的竞赛报名和个人信息' }
};
